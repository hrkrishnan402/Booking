...
class QueryResourceService extends IQueryResourceService {
  ...
  @override
  Future<SearchCityResponse> fetchCities(SearchCityRequest searchCityRequest) async {
    final path = "${ApiConfig.appApiUrl}search?keyword=${searchCityRequest.keyword}";
    Response response = await apiClient.invokeAPI(path, 'GET',
        body: searchCityRequest, headerParams: {"Content-Type": "application/json"});
